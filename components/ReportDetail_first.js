...
export default class ReportDetail_first extends React.Component {
  render() {
    return (
      <View>
        ...
        <View style={styles.MidView}>
          ...
          <View style={styles.ProgbarView}>
            <Progress.Bar progress={0.1} width={270} />
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{flex:1}}></View>
            <View style={{flex:2}}>
            <TouchableOpacity style={styles.ButtonContainer} onPress={()=>this.props.navigation.navigate('Report')}>
...
module.exports = ReportDetail_first;